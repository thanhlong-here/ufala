...
<?php $component->withAttributes(['class' => 'content-wrapper']); ?>
  <nav class="navbar-fixed-top p-1 shadow  navbar-light">
    <div class="navbar-wrapper">
      <h4 class="content-header">
        Mã đơn hàng :
        <span class="text-bold-600"> #<?php echo e($order->prefix); ?>-<?php echo e($order->id); ?></span>
      </h4>
  ...
  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form','data' => ['method' => 'PUT','enctype' => 'multipart/form-data','action' => ''.e(route('orders.update',$order)).'']]); ?>
<?php $component->withName('form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['method' => 'PUT','enctype' => 'multipart/form-data','action' => ''.e(route('orders.update',$order)).'']); ?>
          ...
          <div class="card shadow">
            <div class="card-block">
              ...
              <table class="table">
                ...
                <tbody>
                  <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sold): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td>
              ...
              <div class="text-xs-right">
                ...
                <label class="mr-2"> Giá trị đơn hàng : <span class="text-bold-600"> <?php echo e(number_format($order->total)); ?> đ </span> </label>
          ...
          <div class="card shadow">
            ...
            <div class="card-block">
              <div class="row">
                ...
                <span class="text-bold-600"> <?php echo e($order->customer->name ?? ''); ?> </span>
              </div>
              <div class="row">
                <label class="col-xs-4"><?php echo e(__('Số di động')); ?>:</label>
                <span class="text-bold-600"> <?php echo e($order->customer->phone_number ?? ''); ?></span>
              </div>

              <div class="row">
                <label class="col-xs-4"><?php echo e(__('Địa chỉ')); ?>:</label>
                <span class="text-bold-600"><?php echo e($order->customer->address ?? ''); ?></span>
              </div>
              <div class="row">
                <label class="col-xs-4"><?php echo e(__('Khu vực')); ?>:</label>
                <span class="text-bold-600"><?php echo e($order->customer->city->name ?? ''); ?></span>
              </div>
                  ...
                  <fieldset>
                    <div class="input-group">
                      ...
                      <select class="form-control">
                        ...
                        <option <?php echo e(($order->status == $opt ? 'selected' :'' )); ?> value="<?php echo e($opt); ?>"><?php echo e(__($name)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </fieldset>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH D:\www\ufala\resources\views/admin/order/edit.blade.php ENDPATH**/ ?>