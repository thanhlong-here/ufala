        ...
        <div class="col-md-6  font-medium-2">
          <div class="card shadow">
            ...
            <div class="card-block text-xs-center">
              ...
              <button class="btn btn-primary btn-lg block "> <?php echo e(__('Mua ngay')); ?> </button>
              <?php else: ?>
              <button  data-src="<?php echo e(route('login')); ?>"  
              class="widget btn btn-primary btn-lg block"> <?php echo e(__('Mua ngay')); ?>  </button>
              <?php endif; ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH D:\www\ufala\resources\views/web/affiliate/share.blade.php ENDPATH**/ ?>