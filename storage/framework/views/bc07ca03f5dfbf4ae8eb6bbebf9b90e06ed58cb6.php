...
<?php $component->withAttributes(['class' => 'content-wrapper']); ?>
  ...
  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form','data' => ['method' => 'PUT','enctype' => 'multipart/form-data','action' => ''.e(route('dropships.update',$dropship)).'']]); ?>
<?php $component->withName('form'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['method' => 'PUT','enctype' => 'multipart/form-data','action' => ''.e(route('dropships.update',$dropship)).'']); ?>
            ...
            <div class="screen-block">
              <div class="card-block">
                <div class="form-group">
                  ...
                  <input type="text" placeholder="<?php echo e(__('Tên sản phẩm')); ?>" class="form-control font-medium-2" value="<?php echo e($dropship->name); ?>" name="name" />
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.select.categories','data' => ['name' => 'category_id','class' => 'form-control font-medium-2','prefix' => 'dropship','selected' => ''.e($dropship->category_id).'']]); ?>
<?php $component->withName('select.categories'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'category_id','class' => 'form-control font-medium-2','prefix' => 'dropship','selected' => ''.e($dropship->category_id).'']); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'content','placeholder' => ''.e(__('Mô tả sản phẩm')).'','mode' => 'editor']); ?><?php echo $dropship->content; ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
                ...
                <div class="form-group row ">
                  <div class="col-md-6">
                    <div class="input-group">
                      ...
                      <input type="number" name="price" value="<?php echo e($dropship->price); ?>" class="form-control font-medium-2">
                  ...
                  <div class="col-md-6">
                    <fieldset class=" position-relative">
                      <div class="input-group position-relative ">
                        ...
                        <input type="number" name="dropship_bonus" value="<?php echo e($dropship->dropship_bonus); ?>" placeholder="20" class="form-control font-medium-2">
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'dropship_content','placeholder' => ''.e(__('Chính sách bán hàng')).'','mode' => 'editor']); ?><?php echo $dropship->dropship_content; ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
            ...
            <div class="screen-block">
              <div class="card-block row up">
                ...
                <div class="col-md-8 thumb">
                  <?php $__currentLoopData = $dropship->medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class='item'>
                    <img class="img-thumb" src="<?php echo e(asset($media->path)); ?>" />
                    <button type="button" data-id="<?php echo e($media->id); ?>" class="remove btn-sm round"> <i class='ft-x'> </i> </button>
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="date" value="<?php echo e($start_at); ?>" name="dropship_start_at" class="form-control">
                    </div>

                    <div class="col-md-4">
                      <label><?php echo e(__(' Thời gian kết thúc ')); ?> :</label>
                      <input type="date" value="<?php echo e($end_at); ?>" name="dropship_end_at" class="form-control">
                    </div>
                    <div class="col-md-4">
                      <label><?php echo e(__(' Giới hạn số lượng ')); ?> :</label>
                      <input type="number" placeholder="<?php echo e(__('Không giới hạn')); ?>" name="dropship_limit" value="<?php echo e($dropship->dropship_limit); ?>" class="form-control">
                    ...
                    <ul class="nav navbar-nav">
                      <li class="nav-item">
                        <select style="width: 200px;" class="form-control pull-left">
                          ...
                          <option <?php echo e($key == $status ? 'selected' : ''); ?> value="<?php echo e($key); ?>"> <?php echo e(__($value)); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <li class="nav-item">
                        <button class="btn btn-primary"><?php echo e(__('Cập nhật ')); ?></button>
                      </li>
                    </ul>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH D:\www\ufala\resources\views/admin/dropship/edit.blade.php ENDPATH**/ ?>