                ...
                <div id="table" class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <button data-toggle="modal" data-action="<?php echo e(route('orders.destroy',$row)); ?>" data-target="#modal-confirm" class="act-form btn close"><i class="ft ft-x"></i></button>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button data-src="<?php echo e(route('dropship-orders.edit',$row)); ?>" class="widget btn btn-sm btn-primary"><i class="ft-edit"></i></button>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?><?php /**PATH D:\www\ufala\resources\views/admin/dropship/order/index.blade.php ENDPATH**/ ?>