...
class ElementBuilderController extends BaseController
{
    //
    ...
    public function __invoke(Request $request,$path=0, $dv='m')
    {
        ...
        if(!empty($path) && Auth::check()){
            $ldp = Landingpage::wherePrefix('element')->whereId($path)->first();
            if($ldp){
                ...
                return view('admin.landingpage.element',['landingpage'=>$ldp,'mode'=>'edit']);
            }
            else
                return view('admin.landingpage.element');
        }else{
            ...
            if(empty($landingpage_temp)){
                ...
                return view('admin.landingpage.element',['landingpage'=>$landingpage]);
            }
            return view('admin.landingpage.element',['landingpage'=>$landingpage_temp]);
        }
