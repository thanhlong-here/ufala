            ...
            <tr style="position: relative">
                ...
                <td>
                    ...
                    <div id="myDropdown-{{ $key }}" class="listHandle">
                        <ul>
                            <li><a href="{{ route('admin.ldp-builder', $row->id) }}" target="_blank">Chỉnh sửa giao diện</a></li>
        ...
        @else
            <tr class="no-temp">
                <td colspan="5">
                    ...
                    <a href="/admin/landingpage-builder" class="btn btn-primary white round"> + Tạo Landing Page </a>
                </td>
            </tr>
        @endif
    </tbody>
        ...
        function getTemplates(page)
        {
            $.ajaxSetup({
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('landingpage.listTemplate') }}",
