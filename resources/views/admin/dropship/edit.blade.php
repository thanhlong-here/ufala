            ...
            <div class="screen-block">
              <div class="card-block">
                ...
                <div class="form-group ">
                  ...
                  <x-editor name="content" placeholder="{{__('Mô tả sản phẩm')}}" mode="editor">{!!$dropship->content!!}</x-editor>
                </div>
            ...
            <div class="screen-block">
              <div class="card-block">
                  ...
                  <div class="col-md-6">
                    <fieldset class=" position-relative">
                      <div class="input-group position-relative ">
                        ...
                        <input type="number" name="dropship_bonus" value="{{$dropship->dropship_bonus}}" placeholder="20" class="form-control font-medium-2">
                ...
                <div class="form-group ">
                  ...
                  <x-editor name="dropship_content" placeholder="{{__('Chính sách bán hàng')}}" mode="editor">{!!$dropship->dropship_content!!}</x-editor>
                </div>
            ...
            <div class="screen-block">
              <div class="card-block row up">
                ...
                <div class="col-md-8 thumb">
                  @foreach($dropship->medias as $media)
                  <div class='item'>
                    <img class="img-thumb" src="{{asset($media->path)}}" />
                ...
                <div class="form-group ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="date" value="{{$start_at}}" name="dropship_start_at" class="form-control">
                    </div>

                    <div class="col-md-4">
                      <label>{{__(' Thời gian kết thúc ')}} :</label>
                      <input type="date" value="{{$end_at}}" name="dropship_end_at" class="form-control">
                    </div>
                    <div class="col-md-4">
                      <label>{{__(' Giới hạn số lượng ')}} :</label>
                      <input type="number" placeholder="{{__('Không giới hạn')}}" name="dropship_limit" value="{{ $dropship->dropship_limit }}" class="form-control">
                    ...
                    <ul class="nav navbar-nav">
                      <li class="nav-item">
                        <select style="width: 200px;" class="form-control pull-left">
                          ...
                          <option {{ $key == $status ? 'selected' : '' }} value="{{$key}}"> {{__($value)}}</option>
                          @endforeach
