  ...
  <x-form action="{{ $action }}" method="{{$method}}" enctype="multipart/form-data">
    ...
    <div class="modal-body h-100">
      <div class="card-block">
        <div class="row">
          ...
          <div class="col-xs-8">
            ...
            <div class="form-group row">
              <div class=" col-xs-6">
                <div class="input-group ">
                  <span class="input-group-addon">{{$prefix}}_</span>
                  <input type="text" value="{{ $block->code }}" class="form-control" placeholder="code" name="code" />
                </div>
              </div>
              <div class="col-xs-6">
                <div class="input-group ">
        ...
        <div class="form-group">
          <x-editor height="80">{{$block->content}}</x-editor>
        </div>
