        ...
        <x-block class="header-navbar navbar-fixed-top white">
            ...
            <ul class="pull-left nav navbar-nav">
                ...
                <li class="ml-2 nav-item">
                    <a href="{{route('landingpage.work')}}" class="nav-link"> <i class="fa fa-chevron-left"></i> {{__("Trở về")}}</a>
                </li>
...
<x-block class="app-content h-100 content  container-fluid">
    ...
    <div class="zoom hw-100">
        <div class="screen" style=" width: {{@$content['width']}}px">
...
@push('meta')
 ...
 <script async src="https://www.googletagmanager.com/gtag/js?id=G-0MEY5X45BH"></script>
 <script>
   window.dataLayer = window.dataLayer || [];
   function gtag(){dataLayer.push(arguments);}
   gtag('js', new Date());
 
   gtag('config', 'G-0MEY5X45BH');
 </script>
@endpush
