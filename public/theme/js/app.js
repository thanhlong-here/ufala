...
(function (window, document, $) {
    ...
    $(".widget").click(function () {
        ...
        $('#widget iframe').attr('src', $(this).data('src'));
    ...
    $('.close-parent').click(function () {
        ...
        $('#widget', parent).removeClass('in');
        $('#widget iframe', parent).attr('src', 'about:blank');
    });

    $('.table-choice tbody tr').click(function () {
        var tb = $(this).closest("tbody");
        tb.find('tr').removeClass('row-selected');

        $(this).addClass('row-selected');
    });

    //Parent widget Resize

    if ($body.hasClass("has-parent")) {
        var height = $body.data('height');
        $('#widget iframe', window.parent.document).height(height);
    }
    $('.act-form').click(function () {
        var act = $(this).data('action');
        var target = $(this).data('target');
        $(target + ' form').attr('action', act);
    });
